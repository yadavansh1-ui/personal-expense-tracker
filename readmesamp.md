...
2.  *Download all project files* (or clone the repository).
...
Grocery : 450.0 Rent : 1200.0 Food : 250.0


```python
🎯 Key Learnings
```
​This project provided hands-on experience and reinforced several key concepts:
​File handling using JSON.
​Modular & menu-driven application design.
​Real-world problem solving using Python.
​Hands-on experience with lists, dictionaries & input handling.
